...
%CC% %CPPFLAGS% %0\..\..\src\sdl_main.cpp -TP -c -o%build%\sdl_main.obj && %CC% %CPPFLAGS% %0\..\..\src\gbemu.cpp -c -o%build%\gbemu.obj && %CC%  %build%\sdl_main.obj %build%\gbemu.obj  %build%\imgui.obj -Zi %0\..\lib\SDL2Main.lib Opengl32.lib Shell32.lib ComDlg32.lib %0\..\lib\SDL2.lib -o%build%\gbemu.exe -MT -link -SUBSYSTEM:WINDOWS
