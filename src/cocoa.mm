...
MetalPlatformState *initMainScreenMetal(SDL_Renderer *renderer) {
    @autoreleasepool {
        ...
        ret->numVertices = ARRAY_LEN(vertices);
        return ret;
    }
}

void renderMainScreenMetal(SDL_Renderer *renderer, 
    MetalPlatformState *metalPlatformState, const PaletteColor *screen,
   ...
   @autoreleasepool {
        ...
        [renderEncoder setVertexBuffer:metalPlatformState->vertexBuffer offset:0 atIndex:0];
        ...
        [renderEncoder drawPrimitives:MTLPrimitiveTypeTriangle vertexStart:0 vertexCount:metalPlatformState->numVertices];
    }
}
